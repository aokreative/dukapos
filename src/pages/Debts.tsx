...
import { money, displayPhone, agingBucket, relativeDays } from '../lib/format'
...
import CustomerProfile, { RepaymentModal } from '../components/CustomerProfile'
...
export default function Debts() {
  ...
  return (
    <div>
      ...
      {payFor && <RepaymentModal customer={payFor.customer} onClose={() => setPayFor(null)} />}
      {detailsFor && <CustomerProfile customer={detailsFor.customer} onClose={() => setDetailsFor(null)} />}
    </div>
  )
}
